...
COVERAGE_ALIASES = {
    ...
    "astar_a": {"ChokedArea"},
    "assign_history_matrix": {"HistoryMatrixSlice", "PropulsionHistoryMatrixSlice"},
    "assign_history_vector": {"HistoryVectorSlice", "PropulsionHistoryVectorSlice"},
    "available_cell_capacity": {"AvailableCellCapacity"},
    "battery_capacity_cost": {"BatteryCapacityCost"},
    "battery_energy_available": {"BatteryEnergyAvailable"},
    "battery_power_dynamics": {"BatteryPowerHistory", "BatteryPowerStep"},
    "battery_replacement_cost": {"BatteryReplacementCost"},
    ...
    "compute_flight_conditions": {"FlightConditions"},
    "cable_weight_for_sizing": {"CableWeightForSizing"},
    "concatenate_matrices": {"ConcatenateMatrices"},
    "concatenate_vectors": {"ConcatenateVectors"},
    "con_size_opt": {
        "CruisePowerAvailableConstraint",
        "DesignOperationalConstraints",
        "DesignSplitBounds",
    },
    "convergence_error": {"ConvergenceError"},
    ...
    "cruise_breguet_discharge_battery": {"CruiseBreguetDetailedBattery"},
    "cruise_breguet_efficiency_triplet": {"CruiseBreguetEfficiencyTriplet"},
    "cruise_breguet_power_history": {"CruiseBreguetPowerHistory"},
    "cruise_breguet_power_split": {"CruiseBreguetPowerSplit"},
    "cruise_breguet_propulsive_efficiency": {
        "CruiseBreguetPropulsiveEfficiency"
    },
    "cruise_breguet_source_energy": {"CruiseBreguetSourceEnergy"},
    "cruise_dynamic_pressure": {"CruiseDynamicPressure"},
    "create_prop_arch": {
    ...
    "eval_climb": {"PrescribedRateSegmentKinematicsPower"},
    "eval_cruise": {"CruiseSegmentKinematicsPower"},
    "eval_cruise_breguet": {
    ...
    "eval_descent": {"PrescribedRateSegmentKinematicsPower"},
    "eval_detailed_takeoff": {"DetailedTakeoffSegmentKinematicsPower"},
    "eval_landing": {"LandingSegmentKinematicsPower"},
    "eval_takeoff": {"TakeoffSegmentKinematics"},
    "fan_system": {"FanFlowSplit"},
    "far25_climb": {"FAR25ClimbConstraint"},
    "far25_engine_gradient": {"FAR25EngineGradient"},
    "feas_step": {"FeasibleStep"},
    "fill_split_values": {"SplitScheduleFill"},
    "gauss_elim": {"GaussianEliminationPivot"},
    "get_splits": {"OptimizedSplitSchedules"},
    "detailed_battery_enabled": {"DetailedBatteryFlag"},
    "electric_motor_power_available": {"ElectricMotorPowerAvailable"},
    "engine_lapse": {"EngineLapse"},
    "engine_thrust_requirement": {"EngineThrustRequirement"},
    "failure_model": {"FailureModel"},
    "get_thrust_sink_efficiency": {"ThrustSinkEfficiency"},
    "gradient_matrix": {"GradientMatrix"},
    "nlgpr": {"GaussianProcessPrediction"},
    "history_array": {"HistoryArray"},
    ...
    "mac_ld": {"MacLiftDragEstimate"},
    "mass_flow_parameter": {"MassFlowParameter"},
    "merit_function": {"MeritFunction"},
    "local_efficiency": {"LocalEfficiency"},
    "local_reynolds": {"LocalReynolds"},
    ...
    "one_based_history_values": {"OneBasedHistoryValues"},
    "operational_objective_value": {"OperationalObjective"},
    "operational_split_constraint_blocks": {"OperationalSplitConstraints"},
    "parallel_hybrid_architecture": {"ParallelHybridArchitecture"},
    "perf_ex_nozzle": {"PerfectExpansionNozzleFlow"},
    "partial_turboelectric_architecture": {"PartialTurboelectricArchitecture"},
    "power_available": {"PowerAvailable"},
    "power_flow": {"PowerFlow"},
    "power_limit_constraints": {"PowerLimitConstraints"},
    "power_management_objective": {"PowerManagementObjective"},
    "power_supplement_check": {"PowerSupplementCheck"},
    "prepare_initial_soc": {"BatteryInitialSOC"},
    "prepare_power_time": {"BatteryPowerTimeBroadcast"},
    "cruise_time_target_to_distance": {"CruiseTimeTargetDistance"},
    ...
    "safe_component_weight": {"SafeComponentWeight"},
    "sanitize_array": {"SanitizedArray"},
    "sanitize_gradient": {"SanitizedGradient"},
    "sanitize_values": {"SanitizedValues"},
    "series_hybrid_architecture": {"SeriesHybridArchitecture"},
    "simple_off_design": {"SimpleOffDesignTurbofan"},
    "simplex_post": {"SimplexPostSplitHistory"},
    "simplex_setup": {"OperationalSimplexTableau"},
    ...
    "transmitter_fan_efficiency": {"TransmitterFanEfficiency"},
    "turb_stage": {"TurbineStageFlow"},
    "turbofan_linear_sizing": {"TurbofanLinearSizing"},
    "turboprop_airframe_fit": {"TurbopropAirframeWeight"},
    "turboprop_linear_sizing": {"TurbopropLinearSizing"},
    "turboelectric_architecture": {"TurboelectricArchitecture"},
    "two_dimensional": {"TwoDimensionalArray"},
    "update_battery_energy": {"BatteryEnergyCutoff", "BatteryEnergyHistory"},
    "zero_if_empty": {"ZeroIfEmpty"},
    "zero_if_empty_constraints": {"ZeroIfEmpty"},

...
- Propulsion parallel-hybrid, series-hybrid, and turboelectric architecture
  matrix builders for architecture, split, efficiency, source-type, and
  transmitter-type arrays with analytical partial derivatives.
...
- Propulsion: `CableWeightForSizing`, `EngineLapse`,
  ...
  `SeriesHybridArchitecture`, `ThrustSinkEfficiency`, `TransmitterFanEfficiency`,

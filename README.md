...
- Propulsion parallel-hybrid and series-hybrid architecture matrix builders
  for architecture, split, efficiency, source-type, and transmitter-type
  arrays with analytical partial derivatives.

...
| `database.py` | candidate | MAC, turbofan cruise, turbofan MAC/Reynolds, and turboprop cruise lift-to-drag estimates plus shared airframe weight, weight fraction, wing-loading, geometry, payload, burden, fixed-branch airplane design-group percent margins, fan thrust-normalization, and prop power-normalization preprocessing equations converted; database loading, field mutation, keyword classification, and regression source processing remain support. |

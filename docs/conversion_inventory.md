...
| `database.py` | candidate | MAC and turboprop cruise lift-to-drag estimates plus shared airframe weight, weight fraction, wing-loading, geometry, payload, and burden preprocessing equations converted; database loading, field mutation, keyword classification, and regression source processing remain support. |

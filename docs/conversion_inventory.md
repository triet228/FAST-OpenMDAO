...
| `engine.py` | candidate | Isentropic pressure, temperature, area-Mach, mass-flow, density, fitted specific-heat, thermally perfect gamma update, local Reynolds, and local efficiency primitives converted; nozzle iteration, thermodynamic cycle, fan, compressor, turbine, and sizing components remain. |

...
| `propulsion.py` | candidate | Engine lapse, power-flow propagation, safe component weight, efficiency selectors, and supplemental transmitter power converted; architecture, sizing, fuel-use, and history components remain. |

...
| `database.py` | candidate | MAC and turboprop cruise lift-to-drag estimates plus shared airframe weight, weight fraction, and wing-loading preprocessing equations converted; database loading, field mutation, keyword classification, and regression source processing remain support. |

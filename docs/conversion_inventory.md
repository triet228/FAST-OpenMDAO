...
| `analysis.py` | candidate | Scalar convergence-error, source-weight vectorization, source-weight summation, and analysis-loop MTOW/OEW/source-weight update helpers converted; top-level analysis group coordinating weights, mission, propulsion, and convergence remains. |

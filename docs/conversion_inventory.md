...
| `oew.py` | candidate | Turboprop airframe-weight linear fit, one-step turboprop OEW fixed-point balance, turbofan airframe-weight regression, and numeric-sum helper converted; OEW loop orchestration and turbofan fixed-point group remain. |

...
| `propulsion.py` | candidate | Engine lapse, safe component weight, efficiency selectors, and supplemental transmitter power converted; power-flow, architecture, sizing, fuel-use, and history components remain. |
